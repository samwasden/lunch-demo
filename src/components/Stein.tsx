...
export const Stein = ({ progressValue }: { progressValue: MotionValue }) => {
  ...
  return (
    ...
    >
      ...
      <motion.path
        d="M100 79.5C100 79.5 100 326.856 100 378.175C100 429.494 100 429.494 144.087 429.494C188.173 429.494 256.048 429.494 300.134 429.494C344.221 429.494 344.221 429.494 344.221 378.175C344.221 326.856 344.221 351.117 344.221 351.117M344.221 351.117C344.221 351.117 344.221 322.795 372.29 322.795C400.36 322.795 400.36 322.795 400.36 297.459C400.36 272.122 400.36 272.122 400.36 272.122V230V198.5C400.36 198.5 400.36 208.836 400.36 183.5C400.36 158.164 400.36 145.44 372.29 145.44C344.221 145.44 344.221 145.44 344.221 145.44M344.221 351.117V145.44M344.221 145.44V79.5"
        stroke="white"
        stroke-width="40"
